...
<module external.linked.project.id=":capacitor-android" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../../android" external.system.id="GRADLE" version="4">
