...
<p align="center">
  In Ionic/Angular Applications, the <code>@capacitor-community/sqlite@latest</code> can be accessed through a Singleton Service initialized in the <code>app.component.ts</code></p>
<br>
